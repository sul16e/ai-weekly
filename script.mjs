...
발음 표기 규칙: intro/para/outro 안에서 낭독 시 발음이 헷갈릴 만한 영어 고유명사·약어·기술용어는 {{원어|한글 발음}} 형식으로 감싸라. 예: {{iroh|아이로}}, {{CoreWeave|코어위브}}, {{Nebius|네비우스}}, {{AGI|에이지아이}}. 누구나 아는 것(AI, GPT, 애플)은 제외 — 진짜 헷갈리는 것만.
...
// 마크다운 버전 ({{원어|발음}} → 원어(발음: …))
const plain = (t) => (t || "").replace(/\{\{([^|{}]+)\|([^|{}]+)\}\}/g, "**$1**(발음: $2)");
